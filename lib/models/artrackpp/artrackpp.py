...
from lib.models.artrackpp.vit import vit_base_patch16_224, vit_large_patch16_224
from lib.utils.box_ops import box_xyxy_to_cxcywh


class ARTrackpp(nn.Module):
    """ This is the base class for ARTrackpp """
...
def build_artrackpp(cfg, training=True):
    current_dir = os.path.dirname(os.path.abspath(__file__))  # This is your Project Root
    pretrained_path = os.path.join(current_dir, '../../../pretrained_models')
    if cfg.MODEL.PRETRAIN_FILE and ('ARTrackpp' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    if 'ARTrackpp' in cfg.MODEL.PRETRAIN_FILE and training:
